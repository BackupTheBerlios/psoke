&nbsp;
			<table border="0" class="font-small" width="150" cellspacing="0" cellpadding="0">				
				<tr>
					<td width="130" class="navi-top-right">KINOFILM SUCHE</td>
				...
				<form method="POST" action="index.php?p=cinema|new&a=index"><BR>
				...
				<input type="checkbox" value="Login" checked name="search_option"> Titel<BR>
